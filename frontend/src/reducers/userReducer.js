import {
    ...
    FOLLOW_USER_FAIL, FOLLOW_USER_REQUEST, FOLLOW_USER_RESET, FOLLOW_USER_SUCCESS,
...
export const privacyReducer = (state = {}, { type, payload }) => {
    switch (type) {
