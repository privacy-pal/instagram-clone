import {
    ALL_USERS_FAIL, ALL_USERS_REQUEST, ALL_USERS_SUCCESS, CLEAR_ERRORS,
    FOLLOW_USER_FAIL, FOLLOW_USER_REQUEST, FOLLOW_USER_SUCCESS,
    FORGOT_PASSWORD_FAIL, FORGOT_PASSWORD_REQUEST, FORGOT_PASSWORD_SUCCESS,
    LOAD_USER_FAIL, LOAD_USER_REQUEST, LOAD_USER_SUCCESS, LOGIN_USER_FAIL,
    ...
    DATA_ACCESS_REQUEST, DATA_ACCESS_SUCCESS, DATA_ACCESS_FAIL,
    DATA_DELETION_REQUEST, DATA_DELETION_SUCCESS, DATA_DELETION_FAIL,
...
// Get Privacy Data
export const getPrivacyData = () => async (dispatch) => {
    try {

        dispatch({ type: DATA_ACCESS_REQUEST });

        setTimeout(async () => {
            const { data } = await axios.get('/api/v1/privacy/data');
            dispatch({
                type: DATA_ACCESS_SUCCESS,
                payload: data,
            });
        }, 1000);
...
// Delete Privacy Data
// Get Privacy Data
export const deletePrivacyData = () => async (dispatch) => {
    try {

        dispatch({ type: DATA_DELETION_REQUEST });

        setTimeout(async () => {
            const { data } = await axios.delete('/api/v1/privacy/data');
            dispatch({
                type: DATA_DELETION_SUCCESS,
                payload: data,
            });
        }, 1000);
